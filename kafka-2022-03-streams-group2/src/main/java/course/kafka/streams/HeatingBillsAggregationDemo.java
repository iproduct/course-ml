...
public class HeatingBillsAggregationDemo {
    ...
    public static void main(String[] args) {
        ...
        var countAndSum = internalTempStream
...
////                );
        ...
        var readingsAverage =
                countAndSum.mapValues(countSum -> countSum.getSum() / countSum.getCount(),
                        Materialized.with(
                                WindowedSerdes.timeWindowedSerdeFrom(String.class, WINDOW_SIZE_MS),Serdes.Double())
